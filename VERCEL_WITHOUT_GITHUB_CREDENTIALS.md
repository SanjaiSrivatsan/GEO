...
### On Your Computer:
```
process.env.MONGODB_URL = "mongodb://geo_user:<your-db-password>@..." (from .env)
process.env.GROQ_API_KEY = "gsk_..." (from .env)
```

### On Vercel:
```
process.env.MONGODB_URL = "mongodb://geo_user:<your-db-password>@..." (from Dashboard)
...
5. Fill in:
   Name: MONGODB_URL
   Value: mongodb://geo_user:<your-db-password>@...
6. Click: Save
7. Repeat for:
   - JWT_SECRET
   - GROQ_API_KEY
