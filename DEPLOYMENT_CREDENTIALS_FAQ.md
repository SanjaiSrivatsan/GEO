...
✅ ADDED TO .env
Status: Active
Key: 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
...
Value: mongodb://geo_user:Sanjai1411@ac-kvr63co-shard-00-00.homadcz.mongodb.net:27017,ac-kvr63co-shard-00-01.homadcz.mongodb.net:27017,ac-kvr63co-shard-00-02.homadcz.mongodb.net:27017/geo-db?ssl=true&replicaSet=atlas-3eekln-shard-0&authSource=admin&appName=Cluster0&retryWrites=true&w=majority
```

```
Variable Name: JWT_SECRET
Value: geo-platform-secret-key-2026-production-ready
```

```
Variable Name: GROQ_API_KEY
Value: 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
```
...
MongoDB Pass: Sanjai1411
Groq API Key: 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
```
